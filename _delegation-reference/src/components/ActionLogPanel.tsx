...
import { useAgencyStore, getActiveAgentSet, DebugLogEntry } from '../store/agencyStore'
...
`.trim();
  ...
  return (
    <div className="w-[320px] h-full bg-white border-r border-zinc-100 flex flex-col pointer-events-auto overflow-hidden shrink-0 relative">
          ...
          {/* Tab Switcher - HIDDEN: Technical tab removed, always show Activity */}
          <div className="flex border-b border-zinc-100 bg-zinc-50/30 hidden">
            <button
