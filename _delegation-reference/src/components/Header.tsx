    ...
    <header className="h-14 border-b border-zinc-100 flex items-center justify-between px-6 bg-white shrink-0 relative z-40">
      ...
      <div className="flex items-center gap-4">
        <div className="flex flex-col">
          ...
          <span className="text-lg font-bold text-zinc-900 leading-none tracking-tighter">Orchestra</span>
        </div>
       ...
       <div className="flex items-center gap-4 self-start mt-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://github.com/devpras22/the-orchestra"
              target="_blank"
              rel="noopener"
      ...
      <div className="flex items-center gap-4">
        {/* Debug Mode - HIDDEN for now, may need later
        <button
        ...
        */}
        ...
        {/* API Key button - HIDDEN for now, may need later
        <button
      ...
      <AnimatePresence>
        {/* BYOK Modal - HIDDEN: Never show API key modal */}
        {/* {isBYOKOpen && (
