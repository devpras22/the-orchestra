...
// Teams where all agents can chat freely (Orchestra-specific behavior)
const ORCHESTRA_CONTROLLED_SETS = ['the-orchestra', 'story-spark-studios', 'idea-lab']
...
export function useChatAvailability(agentIndex: number | null): ChatAvailability {
  ...
  // Orchestra teams: all agents can chat freely
  if (ORCHESTRA_CONTROLLED_SETS.includes(selectedAgentSetId)) {
